...
func (a *App) httpServer(coordinatorRouter http.Handler, stageRunner http.Handler, runtimeDeployment http.Handler, runtimeGeneration http.Handler) *http.Server {
	return &http.Server{
		Addr: a.cfg.Listen,
