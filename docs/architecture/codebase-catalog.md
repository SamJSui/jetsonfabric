...
| `deployment` | memory admission | Compares an engine-provided stage-weight estimate with Linux `MemAvailable` and a fixed post-load safety floor before runtime allocation. |
